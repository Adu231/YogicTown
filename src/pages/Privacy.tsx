    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-16">
        ...
        <div className="max-w-3xl mx-auto px-4 md:px-8 py-12">
          <div className="card-wellness mb-6 flex items-start gap-4" style={{ background: 'hsl(133 20% 96%)', borderColor: 'hsl(133 20% 88%)' }}>
            <Shield size={20} className="shrink-0 mt-0.5" style={{ color: 'hsl(133 18% 59%)' }} />
